...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Xrandev - Edit Preset Selector</title>
    ...
    <body class="antialiased bg-gray-100 min-h-screen">
        <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('selector-presets.update', $selectorPreset) }}">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name', $selectorPreset->name) }}" required
                        ...
                        <div>
                            ...
                            <input type="text" id="selector_title" name="selector_title" value="{{ old('selector_title', $selectorPreset->selector_title) }}" required
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="selector_date" name="selector_date" value="{{ old('selector_date', $selectorPreset->selector_date) }}"
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="selector_link" name="selector_link" value="{{ old('selector_link', $selectorPreset->selector_link) }}"
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                ...
                <form method="POST" action="{{ route('selector-presets.destroy', $selectorPreset) }}" class="mt-4">
                    @csrf
                    @method('DELETE')
                    <button type="submit" onclick="return confirm('Apakah Anda yakin ingin menghapus preset {{ $selectorPreset->name }}? Ini mungkin mempengaruhi situs monitoring yang menggunakannya.')"
