                ...
                <form method="POST" action="{{ route('monitoring.sources.update', $source) }}">
                    ...
                    @method('PATCH') <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="url" id="urlInput" name="url" value="{{ old('url', $source->url) }}" required
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                ...
                                @foreach($regions->where('type', 'Provinsi') as $provinsi)
                                    <optgroup label="{{ $provinsi->name }}">
                                        @foreach($regions->where('parent_id', $provinsi->id) as $kabkota)
                                            <option value="{{ $kabkota->id }}" {{ old('region_id', $source->region_id) == $kabkota->id ? 'selected' : '' }}>
                                                {{ $kabkota->name }}
                                            </option>
                                        @endforeach
                                    </optgroup>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="crawlUrlInput" name="crawl_url" value="{{ old('crawl_url', $source->crawl_url) }}"
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input type="text" id="selectorTitleInput" name="selector_title" value="{{ old('selector_title', $source->selector_title) }}" required
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="selectorDateInput" name="selector_date" value="{{ old('selector_date', $source->selector_date) }}"
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                        ...
                        <div>
                            ...
                            <input type="text" id="selectorLinkInput" name="selector_link" value="{{ old('selector_link', $source->selector_link) }}"
                                class="block w-full mt-1 border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
